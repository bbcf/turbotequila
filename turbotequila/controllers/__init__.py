# -*- coding: utf-8 -*-
"""Controllers for the turbotequila application."""

from turbotequila.controllers.error import ErrorController
from turbotequila.controllers.login import LoginController
